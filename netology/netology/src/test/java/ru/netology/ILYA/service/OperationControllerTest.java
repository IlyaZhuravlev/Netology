package ru.netology.ILYA.service;

import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.test.context.SpringBootTest;
import ru.netology.ILYA.configuration.OperationProperties;
import ru.netology.ILYA.controller.OperationController;
import ru.netology.ILYA.controller.DTO.OperationDTO;
...
class OperationControllerTest {
    ...
    void addOperationsTest() throws InterruptedException {
        OperationDTO dto = new OperationDTO(1, 1, 100, "RUB", "Epic");
    ...
    void getOperationsTest() throws InterruptedException {
        OperationDTO operation1 = new OperationDTO(2, 1, 100, "RUB", "Epic");
        operationController.addOperation(operation1);
        Thread.sleep(properties.getTimeout() + 100);
        OperationDTO operation2 = new OperationDTO(3, 1, 200, "RUB", "Epic");
