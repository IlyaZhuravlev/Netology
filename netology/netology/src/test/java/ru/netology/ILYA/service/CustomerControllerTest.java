...
import ru.netology.ILYA.OperationHistoryApiApplicationTest;
import ru.netology.ILYA.controller.CustomerController;
...
class CustomerControllerTest extends OperationHistoryApiApplicationTest {
    ...
    void addAndRemoveCustomer() {
        ...
        customerController.addCustomer(3, "Ilya");
        ...
        assertEquals("Ilya", newCustomer.getName());
